        ...
        <div className="max-w-4xl mx-auto p-6">
            ...
            <div className="mt-6 flex justify-end space-x-4">
                ...
                <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                    ...
                    <DialogContent>
                        <DialogHeader>
                            <DialogTitle>Are you sure you want to delete this vacancy?</DialogTitle>
                            <DialogDescription>
                                This action cannot be undone. This will permanently delete the vacancy and remove the
